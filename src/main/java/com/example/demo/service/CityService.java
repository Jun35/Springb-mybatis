...
public class CityService {
    ...
    public List<City> listCity( RowBounds rowBounds) {
        return (List<City>) cityMapper.selelctList( rowBounds );
    }
    ...
    public List<City> listLikeCity(String cityName) {
        return (List<City>) cityMapper.selelctLike(cityName);
    }
}
